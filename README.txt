...
### Because clinic data is too large to run (1779966 complete records), we got the results by adopting parallel computing. E.g. To run SKNN method using clinic data on a 24-cores server with 140G memory, it cost 26h, 170h, and 280h wrt miss_rate=0.01, 0.05 and 0.1 respectively.
